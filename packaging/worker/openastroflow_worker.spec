...
"""One-directory worker spec used by ``scripts/build_worker_sidecar.py``.
...
worker_name = os.environ.get("OAF_WORKER_BASENAME")
if not worker_name or "/" in worker_name or "\\" in worker_name:
    raise SystemExit("OAF_WORKER_BASENAME must be a portable file basename")
