...
from ufwbpp.hardware import CpuFamily, HardwareProfile, detect_hardware
from ufwbpp.performance_profile import (
    GIB,
...
from ufwbpp.platform import CpuTopology, MemoryStatus
...
def test_x86_64_table_scales_with_memory_and_cores() -> None:
    ...
    assert (small.cpu_workers, small.integration_tile_rows) == (2, 32)
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            {"cpuWorkers": 4, "qcWorkers": 3, "kernelThreads": 16, "integrationTileRows": 48},
        ),
        (
            ...
            {"cpuWorkers": 8, "qcWorkers": 8, "kernelThreads": 20, "integrationTileRows": 48},
        ),
        (
            ...
            {"cpuWorkers": 2, "qcWorkers": 2, "kernelThreads": 8, "integrationTileRows": 32},
        ),
        (
            ...
            {"cpuWorkers": 8, "qcWorkers": 8, "kernelThreads": 64, "integrationTileRows": 48},
        ),
    ],
)
