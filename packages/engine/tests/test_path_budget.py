...
from ufwbpp.path_budget import (
...
from ufwbpp.platform import PathLimit
from ufwbpp.platform.windows import LONG_PATHS_REGISTRY_KEY, path_limit
from ufwbpp.recipe import Recipe
from ufwbpp.runtime import (
...
def test_prepare_execution_refuses_windows_outside_x86_64(nina_project: Path, tmp_path: Path) -> None:
    ...
    from ufwbpp.runtime import refuse_unsupported_platform
