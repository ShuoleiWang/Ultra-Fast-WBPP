"""Original-pixel crop coordinate contract of the blink native crops."""
from pathlib import Path

from astropy.io import fits
import numpy as np

from ufwbpp.blink.diagnostics import DisplayReference
from ufwbpp.blink import native_crops as study
