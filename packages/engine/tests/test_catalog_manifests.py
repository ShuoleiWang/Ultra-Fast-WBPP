...
import ufwbpp.solvers


# The checked manifests ship as package data of the solvers package.
CATALOGS = Path(ufwbpp.solvers.__file__).resolve().parent / "catalog_manifests"
