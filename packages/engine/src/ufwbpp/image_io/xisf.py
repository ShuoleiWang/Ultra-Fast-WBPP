...
from ..stacking.integration import CalibrationError, FitsFloatWriter
...
def convert_xisf_to_fits(
    ...
    *,
    ...
    if before != after or sha256_digest(source) != source_sha256:
    ...
    return XisfConversionReceipt(
        ...
        converted_sha256=sha256_digest(destination),
