...
_APPLE_SILICON_BANDS = (
    _Band(12, workers=2, tile_rows=24, gpu_inflight_buffers=1),
    _Band(16, workers=4, tile_rows=32, gpu_inflight_buffers=1),
    _Band(24, workers=4, tile_rows=32, gpu_inflight_buffers=1),
    _Band(float("inf"), workers=8, tile_rows=48, gpu_inflight_buffers=2),
)
...
_X86_64_BANDS = (
    _Band(12, workers=2, tile_rows=32, gpu_inflight_buffers=0),
    _Band(16, workers=4, tile_rows=32, gpu_inflight_buffers=0),
    _Band(24, workers=4, tile_rows=48, gpu_inflight_buffers=0),
    _Band(float("inf"), workers=8, tile_rows=48, gpu_inflight_buffers=0),
)
_PORTABLE_BANDS = (
    _Band(16, workers=2, tile_rows=32, gpu_inflight_buffers=0),
    _Band(float("inf"), workers=4, tile_rows=48, gpu_inflight_buffers=0),
)
