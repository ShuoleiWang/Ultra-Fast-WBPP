...
from openastroflow_engine.blink_diagnostics import DisplayReference, background_grid, diagnostic_preview, detail_transfer, local_noise
...
def test_reference_uses_only_registered_measured_candidates():
    from openastroflow_engine.blink_diagnostics import choose_display_reference
