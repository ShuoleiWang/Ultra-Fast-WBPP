...
def _runtime_backends() -> tuple[RuntimeStageBackend, ...]:
    ...
    def registration_ready() -> bool:
        from openastroflow_registration import run_registration
...
def default_registry() -> BackendRegistry:
    # External executables are instantiated here, so their descriptors contain
    # the result of a real bounded process probe rather than PATH guesses.
    from .siril_backend import SirilBackend
