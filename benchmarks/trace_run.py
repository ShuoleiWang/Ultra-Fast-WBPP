...
TARGETS: tuple[tuple[str, str, str, str], ...] = (
    ...
    ("ufwbpp.stacking.lights", "_calibrate_and_register_frames", "fused.all_lights", "fused"),
    ("ufwbpp.stacking.lights", "_process_light_job", "fused.light_job", "fused"),
    ("ufwbpp.stacking.lights", "_expression_rows", "fused.calibrate_rows", "fused"),
    ("ufwbpp.stacking.lights", "bilinear_debayer", "fused.debayer", "fused"),
    ("ufwbpp.stacking.lights", "_register_frame", "fused.register_frame", "fused"),
    ("ufwbpp.stacking.lights", "_write_float_fits", "io.write_calibrated", "io"),
    ("ufwbpp.stacking.pipeline", "_shared_auto_crop", "crop.shared_auto_crop", "crop"),
    ("ufwbpp.stacking.groups", "_crop_fits", "crop.crop_fits", "crop"),
    ("ufwbpp.native_kernels", "NativeKernels.warp_lanczos3", "native.warp_lanczos3", "native"),
    # normalization
    ("ufwbpp.stacking.normalization", "fit_registered_group_global_normalization", "normalization.fit_group", "normalization"),
    ("ufwbpp.stacking.normalization", "_group_tile_levels", "normalization.group_tile_levels", "normalization"),
    ("ufwbpp.stacking.normalization", "_fit_sky_response", "normalization.fit_sky_response", "normalization"),
    ("ufwbpp.stacking.normalization", "_fit_coefficient", "normalization.fit_coefficient", "normalization"),
    ("ufwbpp.stacking.normalization", "_paired_samples", "normalization.paired_samples", "normalization"),
    ("ufwbpp.stacking.normalization", "_fit_additive_offset_grid", "normalization.fit_additive_offset_grid", "normalization"),
    ("ufwbpp.stacking.normalization", "_tile_backgrounds", "normalization.tile_backgrounds", "normalization"),
    ("ufwbpp.stacking.normalization", "_smooth_offset_grid", "normalization.smooth_offset_grid", "normalization"),
    ("ufwbpp.stacking.normalization", "_ReferenceSampleCache.sample", "normalization.reference_sample", "normalization"),
    ("ufwbpp.stacking.normalization", "_ReferenceSampleCache.rows", "normalization.reference_rows", "normalization"),
    ("ufwbpp.stacking.integration", "_add_offset_grid_rows", "integration.add_offset_grid_rows", "integration"),
    ("ufwbpp.stacking.transient_rejection", "fast_radon_levels", "transients.fast_radon_levels", "integration"),
    ("ufwbpp.stacking.transient_rejection", "_measure_line", "transients.measure_line", "integration"),
    ("ufwbpp.native_kernels", "NativeKernels.tile_offsets", "native.tile_offsets", "native"),
    # integration
    ("ufwbpp.stacking.metal_integration", "integrate_registered_group", "integration.group", "integration"),
    ("ufwbpp.stacking.integration", "integrate_expressions", "integration.integrate_expressions", "integration"),
    ("ufwbpp.stacking.integration", "_expression_rows", "integration.expression_rows", "integration"),
    ("ufwbpp.stacking.integration", "_expression_sampled_rows", "integration.expression_sampled_rows", "integration"),
    ("ufwbpp.stacking.integration", "_ordinary_integration_tile", "integration.rejection_tile", "integration"),
    ("ufwbpp.stacking.integration", "_prepare_transient_rejection", "integration.prepare_transients", "integration"),
    ("ufwbpp.stacking.integration", "_combined_integration_weights", "integration.weights", "integration"),
    ("ufwbpp.stacking.integration", "_estimate_rejection_sigma_floor", "integration.sigma_floor", "integration"),
    ("ufwbpp.stacking.integration", "robust_location", "integration.robust_location", "integration"),
    ("ufwbpp.stacking.integration", "fit_residual_background", "transients.fit_residual_background", "integration"),
    ("ufwbpp.stacking.transient_rejection", "detect_transient_trails", "transients.detect", "integration"),
    ...
    ("ufwbpp.stacking.integration", "FitsFrame.read_rows", "io.fits_read_rows", "io"),
    ("ufwbpp.stacking.integration", "FitsFrame.read_sampled_rows", "io.fits_read_sampled_rows", "io"),
    ("ufwbpp.stacking.integration", "FitsFrame.full_values", "io.fits_full_values", "io"),
    ("ufwbpp.stacking.integration", "FitsFloatWriter.write_rows", "io.fits_write_rows", "io"),
    ("ufwbpp.stacking.integration", "FitsFloatWriter.__exit__", "io.fits_writer_close", "io"),
    # drizzle
    ("ufwbpp.stacking.drizzle_native", "drizzle_group", "drizzle.group", "drizzle"),
    ("ufwbpp.stacking.drizzle_native", "_sha256_of", "drizzle.sha256", "drizzle"),
    ("ufwbpp.native_kernels", "NativeKernels.drizzle_band", "native.drizzle_band", "native"),
    # astrometry, products, publication
    ("ufwbpp.solvers.astrometry_net", "AstrometryNetBackend.solve", "astrometry.solve_field", "astrometry"),
    ...
    ("ufwbpp.workflows.solve", "_promote_solved_state", "astrometry.promote_solved_state", "astrometry"),
    ...
    ("ufwbpp.workflows.sources", "sha256_digest", "verify.sha256", "verify"),
    ("ufwbpp.products.preview", "render_auto_stretch_preview", "products.preview", "products"),
    ("ufwbpp.products.color", "build_color_product", "products.color_product", "products"),
...
class Tracer:
    ...
    def install_stage_hook(self) -> None:
        try:
            from ufwbpp.workflows import contracts as e2e
