#ifndef OPENASTROFLOW_NATIVE_FUSEDLNINTEGRATION_H
#define OPENASTROFLOW_NATIVE_FUSEDLNINTEGRATION_H
...
struct FusedLnIntegrationRequest
{
   TileRegion tile;
...
struct FusedLnIntegrationResult
{
...
#endif // OPENASTROFLOW_NATIVE_FUSEDLNINTEGRATION_H
