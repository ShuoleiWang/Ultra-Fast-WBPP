...
struct MetalFusedIntegrationExecutor::Impl
{
...
#pragma clang diagnostic pop
         ...
         id<MTLFunction> function = [library
            newFunctionWithName:@"fused_masked_weighted_integration"];
         if ( function == nil )
            throw std::runtime_error(
         ...
         id<MTLFunction> robustFunction = [library
            newFunctionWithName:@"fused_native_robust_integration"];
         ...
         id<MTLFunction> linearFitFunction = [library
            newFunctionWithName:@"fused_native_linear_fit_integration"];
...
MetalFusedIntegrationExecutor::MetalFusedIntegrationExecutor(
   const std::filesystem::path& metalSourcePath )
   : m_impl( std::make_unique<Impl>( metalSourcePath ) )
{
}

MetalFusedIntegrationExecutor::~MetalFusedIntegrationExecutor() = default;

MetalFusedIntegrationExecutor::MetalFusedIntegrationExecutor(
   MetalFusedIntegrationExecutor&& ) noexcept = default;

MetalFusedIntegrationExecutor&
MetalFusedIntegrationExecutor::operator =(
   MetalFusedIntegrationExecutor&& ) noexcept = default;

FusedIntegrationResult MetalFusedIntegrationExecutor::Run(
...
FusedIntegrationResult
MetalFusedIntegrationExecutor::RunNativeRobustRejection(
...
FusedIntegrationResult
MetalFusedIntegrationExecutor::RunNativeLinearFitRejection(
...
MetalFusedIntegrationExecutor::NormalizeOutputRangeInPlace(
