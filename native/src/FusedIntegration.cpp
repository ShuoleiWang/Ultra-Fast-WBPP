...
std::size_t FusedIntegrationRequest::TilePixels() const
{
   return tile.PixelCount();
}

std::size_t FusedIntegrationRequest::GridSamplesPerFrame() const
{
   return CheckedMultiply(
      gridWidth, gridHeight, "Ultra-Fast WBPP native LN grid size overflow" );
}

void FusedIntegrationRequest::Validate() const
{
   tile.Validate();
