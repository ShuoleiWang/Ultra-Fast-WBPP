...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("native/README.md", set()),
        ("docs/evidence/standard-mono-masters-20260906.json", set()),
        ...
        ("native/src/FusedIntegration.cpp", {"python"}),
        ("native/metal/FusedIntegration.metal", {"python"}),
        ...
        ("packages/engine/src/ufwbpp/solvers/catalog_manifests/astap-external-v1.json", {"python"}),
        ("Makefile", {"python"}),
        ("Cargo.lock", {"rust"}),
        ...
        ("apps/desktop/src-tauri/tauri.demo.conf.json", {"rust", "python"}),
